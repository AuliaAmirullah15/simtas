...
<html lang="en">
	...
	<body class="menubar-hoverable header-fixed " onmousemove="myFunction()">
...
<?php
    ...
    echo 
					...
					"<div class=\"alert alert-warning\" role=\"alert\">
						...
						<div class="row">
							<ol class="breadcrumb">
											<li><a href="<?php echo base_url('tugas/penentuan_pembimbing');?>">Daftar Penentuan Pembimbing</a></li>
													...
													<select id="pembimbing1" name="pembimbing1" class="form-control" onchange="myFunction()">
						                              <option value=""></option>
														...
														{ if($dopim->sisa < 1) {?>
															...
															<option value="<?php echo $dopim->sisa; ?>" <?php if($dopim->pembimbing1 == $pemb1) { echo "selected"; }?>><?php echo $dopim->Nama_dosen ; ?><?php if($dopim->pembimbing1 != 'NO') { ?>(<?php echo $dopim->sisa; ?>)<?php } ?></option>

														<?php } else {?>
                                                        
                                                        <option value="<?php echo $dopim->pembimbing1; ?>" <?php if($dopim->pembimbing1 == $pemb1) { echo "selected"; }?>><?php echo $dopim->Nama_dosen ; ?><?php if($dopim->pembimbing1 != 'NO') { ?>(<?php echo $dopim->sisa; ?>)<?php } ?> </option>
														...
														{ if($dosen->kuota < 1) { ?>
															...
															<option value="<?php echo $dosen->kuota; ?>" <?php if($dosen->Kode_dosen == $pemb1) { echo "selected"; }?>><?php echo $dosen->Nama_dosen ; ?><?php if($dopim->pembimbing1 != 'NO') { ?>(<?php echo $dosen->kuota; ?>)<?php } ?></option>

														<?php } else {?>
                                                        
                                                        <option value="<?php echo $dosen->Kode_dosen; ?>" <?php if($dosen->Kode_dosen == $pemb1) { echo "selected"; }?>><?php echo $dosen->Nama_dosen ; ?><?php if($dopim->pembimbing1 != 'NO') { ?>(<?php echo $dosen->kuota; ?>)<?php } ?></option>

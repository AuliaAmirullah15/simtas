					...
					<div class="section-body contain-lg">
						...
						<div class="col-lg-12">
								...
								<article class="margin-bottom-xxl">
									<p class="lead">
									<?php if(empty($set) ) { ?>
									<form class="form" role="form" action="<?php echo base_url('tugas/kelayakan_pengajuan_judul') ?>" method="post">
										<div class="col-sm-3"><select id="select2" name="status" class="form-control">
                                            
												<option value="belum" <?php if($_SESSION['pengajuan'] == 'belum' OR $status == 'NULL') {echo "selected='selected'";} ?> > Belum Dikonfirmasi </option>
                                            
												<option value="diterima" <?php if($_SESSION['pengajuan'] == 'diterima') {echo "selected='selected'";} ?> > Diterima </option>
                                            
                                                <option value="ditolak" <?php if($_SESSION['pengajuan'] == 'ditolak') {echo "selected='selected'";} ?> > Ditolak </option>
														...
														{ 
															?>
																...
																<tr>
                                                                    ...
                                                                    <?php if($d->status_kelayakan == 'ditolak' || $d->status_kelayakan == 'diterima') { ?>
                                                                    <td><?php echo anchor('tugas/verifikasi_kelayakan_pj/'.$d->id_pengajuan,'<button type="button" class="btn btn-info">Lihat</button>') ; ?>
                                                                    </td>
                                                                    
                                                                    <?php } else { ?>
                                                                    <td><?php echo anchor('tugas/verifikasi_kelayakan_pj/'.$d->id_pengajuan,'<button type="button" class="btn btn-success">Verifikasi</button>') ; ?>
                                                                    </td>
                                                                    <?php } ?>

			...
			<div id="content">
				<section>
					...
					<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Data Tesis</h2>
							</div><!--end .col -->
							<!--<div class="col-lg-7">
							...
							<div class="col-lg-12">
								<form class="form-horizontal" method="post" action="<?php echo base_url().'tugas/insert_tesis';?>">
									<div class="card">
										<div class="card-head style-primary">
											<header>Tambah Tesis</header>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<label for="Nomor Tesis" class="col-sm-4 control-label">Nomor Tesis</label>
														<div class="col-sm-8">
															<input type="text" class="form-control" id="id_tesis" name="id_tesis"/>
														</div>
													</div>
												</div>
												<div class="col-sm-6">
											...
											<div class="form-group">
												<label for="Nama Mahasiswa" class="col-sm-2 control-label">Nama Mahasiswa</label>
												<div class="col-sm-10">

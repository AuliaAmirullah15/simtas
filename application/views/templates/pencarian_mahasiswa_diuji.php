		...
		<div id="base">
			...
			<div id="content">
				...
				<div class="section-body">
								...
								<h1 class="text-primary">Pencarian Mahasiswa Yang Diuji</h1>
								...
								<div class="row">
									<div class="card-body">
										...
										<form class="form form-validate" role="form" action="<?php echo base_url('tugas/cari_mahasiswa_diuji') ?>" method="post">
											...
											<div class="form-group floating-label">
												<select id="select2" name="status_pemb" class="form-control">
													...
													<option value="penguji1" <?php if($status_pemb == 'penguji1') echo "selected='selected'" ?>> Penguji 1</option>
													<option value="penguji2" <?php if($status_pemb == 'penguji2') echo "selected='selected'" ?> > Penguji 2</option>

												</select>

												<label for="regular2">Status Penguji</label>
											</div>
											</div>
											...
											<div class="form-group floating-label">
												<select id="select2" name="status" class="form-control">
                                                    ...
                                                    <option value="belum semhas" <?php if($status == 'belum semhas') echo "selected='selected'" ?>> Akan Semhas</option>
													<option value="belum sidang" <?php if($status == 'belum sidang') echo "selected='selected'" ?>> Akan Sidang</option>
													<option value="sudah sidang" <?php if($status == 'sudah sidang') echo "selected='selected'" ?>> Sidang</option>
													<option value="lulus" <?php if($status == 'lulus') echo "selected='selected'" ?>> Lulus</option>
												</select>

												<label for="regular2">Status Mahasiswa</label>
											</div>
											</div>
											...
											<table class="table no-margin">
												...
												<tbody>
														...
														foreach($data as $d)
															{	
																switch($d->status) {
			case 'belum semhas' : $statusnya = "akan semhas";break;
			case 'belum sidang' : $statusnya = "akan sidang";break;
			case 'sudah sidang' : $statusnya = "sidang";break;

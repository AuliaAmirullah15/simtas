				...
				<section>
					...
					<div class="section-body contain-lg">
						...
						<div class="section-header">
										<ol class="breadcrumb">
											<li><a href="<?php echo base_url('tugas/dosen');?>">Dosen</a></li>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-8">
								<form class="form" method="post" action="<?php echo base_url().'tugas/proses_tambah_akun_dsn/';?>" /> 
									<div class="card">
										...
										<div class="card-body">
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<label for="select13" class=" control-label">Dosen</label>
														<select id="dopim1" name="dosen" class="form-control" required>
												<?php
													foreach($dosen as $dsn)
													{
														if($dsn->Kode_dosen != "NO") {
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<input type="text" class="form-control" id="Firstname1" name="username" >

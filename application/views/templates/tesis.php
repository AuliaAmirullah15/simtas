			...
			<div id="content">
				<section class="style-default-bright">
					<div class="section-header">
						<h2 class="text-primary">Tesis</h2>
					</div>
				...
				<?php } ?>
						...
						<div class="row">
								...
								<article class="margin-bottom-xxl">
									<p class="lead">
									<?php if(empty($set) ) { ?>
									<form class="form" role="form" action="<?php echo base_url('tugas/tesis') ?>" method="post">
						...
						<div class="row">
							<div >
								<div class="">
									<div class="card-body">
										<form class="form" role="form" action="<?php echo base_url('tugas/search_tesis') ?>" method="post">
									<div class="row">
										<div class="col-sm-3">	
									...
									<table id="" class="table table-striped table-hover">
										...
										<!-- content of table -->
												...
												<tr>
													...
													<td><button type="button" class="btn btn-info"><?php echo anchor('tugas/update_tesis/'.$d->id_tesis,'Edit'); ?></button></td>
													<td><button type="button" class="btn btn-warning"><?php echo anchor('tugas/delete_tesis/'.$d->id_tesis,'Hapus',array('class'=>'delete_tesis',
						'onclick'=>"return confirmDialog();")
									...
									<div class="row">
									<div class="col-sm-6"><button type="button" class="btn btn-success"><?php echo anchor('tugas/add_tesis/','Tambah Data',array('class'=>'add_tesis')); ?></button></div>

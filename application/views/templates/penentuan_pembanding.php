					...
					<div class="section-body contain-lg">
						...
						<div class="col-lg-12">
								...
								<article class="margin-bottom-xxl">
									<p class="lead">
									<?php if(empty($set) ) { ?>
									<form class="form" role="form" action="<?php echo base_url('tugas/penentuan_pembanding') ?>" method="post">
														...
														{ 
															?>
																...
																<tr>
																	...
																	<td><?php echo anchor('tugas/edit_dopems/'.$d->nim,'<button type="button" class="btn btn-success">Tentukan</button>') ; ?></td>

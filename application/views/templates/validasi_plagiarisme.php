					...
					<div class="section-body contain-lg">
						...
						<div class="col-lg-12">
								...
								<article class="margin-bottom-xxl">
									<p class="lead">
									<?php if(empty($set) ) { ?>
									<form class="form" role="form" action="<?php echo base_url('tugas/validasi_plagiarisme') ?>" method="post">
										<div class="col-sm-3"><select id="select2" name="status" class="form-control">
												...
												<option value="belum_dikonfirmasi" <?php if($status == 'belum_dikonfirmasi') {echo "selected='selected'";} ?> > Belum Dikonfirmasi </option>
                                            
                                                <option value="plagiat" <?php if($status == 'plagiat') {echo "selected='selected'";} ?> > Plagiat </option>
                                            
                                                <option value="original" <?php if($status == 'original') {echo "selected='selected'";} ?> > Original </option>
												</select>
												</div>
														...
														{ 
															?>
																...
																<tr>
																	...
																	<td><?= $d->judul ?></td>
                                                                    <td><?= $d->keywords ?> </td>
                                                                    <td><?= $d->status_plagiarisme ?></td>
                                                                    <td><?php echo anchor('tugas/status_plagiarisme/plagiat/'.$d->id_pengajuan,'<button type="button" class="btn btn-danger" OnClick="return confirm(\'Yakin Skripsi Ini Mengandung Unsur Plagiat?\')">Plagiat</button>') ; ?>
                                                                    
                                                                    <?php echo anchor('tugas/status_plagiarisme/original/'.$d->id_pengajuan,'<button type="button" class="btn btn-info" OnClick="return confirm(\'Yakin Skripsi Ini Original?\')" >Original</button>') ; ?>
                                                                    </td>
                                                                </tr>

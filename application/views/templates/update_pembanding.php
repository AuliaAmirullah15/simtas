		...
		<div id="base">
			...
			<div class="card">
							...
							<div class="card-body">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo base_url().'tugas/proses_update_pembanding/'.$id.'/'.$id_seminar;?>" >

										<div class="col-md-12">
										<div class="row">
										<label for="nim" class="col-sm-2 control-label">NIM</label>
										<div class="col-sm-4 form-group">
											<input class="form-control" type="text" name="nim" value="<?= $nim ?>" disabled> 
									...
									<div class="form-group">
										<label for="Pembanding1" class="col-sm-2 control-label">Pembanding 1 </label>
										<div class="col-sm-10">
											<div class="input-group">
												
													<select id='dosen' name='pembanding1' class='form-control'>
													
														<?php foreach($dosen as $dos) { ?>

														<?php if($pembanding1 == $dos->Kode_dosen){ ?>

														<option value="<?php echo $dos->Kode_dosen; ?>" selected='selected'> <?php echo $dos->Nama_dosen ; ?></option>
														<?php } else { ?>
														<option value="<?php echo $dos->Kode_dosen; ?>"> <?php echo $dos->Nama_dosen ; ?></option>
														<?php }} ?>
									...
									</div><!--end Pembanding 2 -->

									<div class="form-group">
										<label for="Pembanding2" class="col-sm-2 control-label">Pembanding 2 </label>
										<div class="col-sm-10">
											<div class="input-group">
												
													<select id='dosen' name='pembanding2' class='form-control'>
													
														<?php foreach($dosen as $dos) { ?>

														<?php if($pembanding2 == $dos->Kode_dosen){ ?>

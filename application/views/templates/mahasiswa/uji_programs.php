...
else if($error == 'Simpan Sementara Berhasil')
{
    echo "
        <div class=\"section-body\">
						<div class=\"alert alert-success\" role=\"alert\">
							<strong>Selamat! </strong> Anda berhasil menyeimpan sementara <b>Berkas Persetujuan Semhas</b></div>
    ";
}
else
{
										...
										<div class="col-md-9">
											<article class="style-default-bright">
												<div class="card-body">
                                                    ...
                                                    <a href="<?php echo base_url().'mahasiswa/riwayat_bimbingan/semhas'. $nim; ?>"><p class="lead">Riwayat Bimbingan Pra Seminar Hasil</p></a>
													<hr>
													<hr>
													
                                                    <h3 class="text-light"><strong>Pengumuman</strong></h3>
                                                    <p class="text-light">Untuk menyelesaikan tahap uji program, lakukan tahap-tahap berikut: </p>
                                                    <ul class="customli">
                                                        ...
                                                        <li>2. Lakukan uji program bersama dosen pembimbing </li>
                                                    </ul>
                                                    ...
                                                    <ul class="customli">
                                                        <li>1. Form Penilaian Uji Program </li>
                                                        <li>2. Form Persetujuan Semhas</li>
                                                    </ul>
                                                    <p class="text-light">Berkas di atas harus diupload dalam format <strong>zip</strong> atau <strong>rar</strong>.</p>
                                                    <p class="text-light">Format File : nim_NamaBerkas_ujiprogram.rar / nim_NamaBerkas_ujiprogram.zip</p>
                                                    
                                                  <?php foreach($mahasiswa as $m) { $state = $m->uji_program; } if($state == 1) { 
                                                    ...
                                                    <form class="form" method="post" action="<?php echo base_url().'mahasiswa/post_berkas/uji_program';?>" enctype="multipart/form-data">
													<br>
													...
													<input type="file" name="berkas" <?php if($jumlah_bimbingan < 3) {echo "disabled";} ?>>
                                                    <button type="submit" class="btn btn-warning" name="simpan" value="simpan_sementara" <?php if($jumlah_bimbingan < 3) {echo "disabled";} ?>>
													Simpan Sementara</button>
													<button type="submit" class="btn btn-success" name="submit" value="submit" OnClick="return confirm('Yakin Berkas Ini Sudah Benar? Anda tidak akan dapat mengeditnya lagi')" <?php if($jumlah_bimbingan < 3) {echo "disabled";} ?>>
													Submit</button>
													</form><?php } ?>

	...
	<body class="menubar-hoverable header-fixed ">
		...
		<?php
			foreach($data as $d)
			{
				...
				$nip1 = $d->nip1;
				$nip2 = $d->nip2;
				$pembanding1 = $d->pembanding1;
				$pembanding2 = $d->pembanding2;
				$nip3 = $d->nip3;
				$nip4 = $d->nip4;
				$ilmu1 = $d->ilmu1;
				$ilmu2 = $d->ilmu2;
			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">Form Persetujuan Sidang Meja Hijau</li>
						</ol>
					</div>
									...
									<div class="card-body style-default-bright">
										...
										<div class="row">
											<div class="col-xs-12 text-center">
												<h4>FORM PERSETUJUAN SIDANG MEJA HIJAU</h4>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-xs-12">
												<h4 class="text-light">Telah memenuhi persyaratan dan disetujui untuk <b>Sidang Meja Hijau</b>.</h4>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-5">
												...
												<h4 class="text-light">: <?php if(empty($nip1)) {echo "......................................................................";} else{ echo $nip;} ?></h4> 
											</div>
											<div class="col-xs-4">
										...
										<div class="row">
											...
											<div class="col-xs-5">
												<h4 class="text-light">: <?= $pembanding1 ?></h4> 
												<h4 class="text-light">: <?php if(empty($nip3)) {echo "......................................................................";} else{ echo $nip3;} ?></h4> 
											</div>
											<div class="col-xs-4">
											<h4>3. <?php if($penguji1 != '0000-00-00') { if($ttd3 != '') { ?>   <img src="<?php echo base_url('ttd_dosen/'. $ttd3); ?>" width="60px" height="60px">  <?php } } ?></h4>
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-xs-5">
												<h4 class="text-light">: <?= $pembanding2 ?></h4> 
												<h4 class="text-light">: <?php if(empty($nip4)) {echo "......................................................................";} else{ echo $nip4;} ?></h4> 
											</div>
											<div class="col-xs-4">
											<h4>4. <?php if($penguji2 != '0000-00-00') { if($ttd4 != '') { ?>   <img src="<?php echo base_url('ttd_dosen/'. $ttd4); ?>" width="60px" height="60px">  <?php } } ?></h4>
											</div>
										</div>
									</div><!--end .card-body -->
								</div><!--end .card -->

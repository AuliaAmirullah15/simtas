			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">Form Validasi Berkas Mahasiswa Sebagai Persyaratan Sidang Meja Hijau</li>
						</ol>
					</div>
									...
									<div class="card-body style-default-bright">
										...
										<div class="row">
											<div class="col-xs-12 text-center">
												<h4>FORM VALIDASI BERKAS MAHASISWA<br> SEBAGAI PERSYARATAN SIDANG MEJA HIJAU</h4>
											</div>
										</div>

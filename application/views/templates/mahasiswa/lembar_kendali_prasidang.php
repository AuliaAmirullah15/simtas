			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
							<li class="active">Lembar Kendali Bimbingan Skripsi Pra Sidang Meja Hijau</li>
						</ol>
					</div>
									...
									<div class="card-body style-default-bright">
										...
										<div class="row">
											<div class="col-xs-12 text-center">
												<h4>LEMBAR KENDALI BIMBINGAN SKRIPSI<br> PRA SIDANG MEJA HIJAU</h4>
											</div>
										</div>
											...
											<div class="col-xs-12 text-center">
												<table border='1' width="100%">
													<tbody>
														...
														<tr height="30px">
															<td width="10%" style="padding-left:3px;padding-right:3px;">Penyerahan</td>
															<td width="10%"  style="padding-left:3px;padding-right:3px;">Selesai Diperiksa</td>
															<td width="10%"  style="padding-left:3px;padding-right:3px;">Terima Kembali</td>
														</tr>
															<?php 
										...
										<div class="row">
											...
											<div class="col-xs-4">
													...
													<table class="boxes text-center" border='3' width="70%">
														<tr height="25px">
															<td>Rencana Tanggal <br>Seminar Hasil</td>
														</tr>
														<tr height="25px">
														<td></td>
														</tr>
											...
											<div class="col-xs-3">
												...
												<center><h5 class="text-light">Medan, .......................................
													<br>
													Pembimbing I,
													<br><br><br><br><br><br>
												</h5>

				...
				<?php if($message != '' AND $message != null) {
					...
					<div class=\"section-body\">
						<div class=\"alert alert-success\" role=\"alert\">
							...
							?>
					<div class="col-lg-12">
								<h1 class="text-primary">Seminar Hasil</h1>
							</div><!--end .col -->
														...
														foreach($data as $d)
														{
															echo "
																<tr>
																	<td>$no</td>
																	<td>$d->nim</td>
																	<td>". anchor('tugas/tampil_persetujuan/'.$d->persetujuan_semhas,'Lihat File')."</td>
																	<td>". anchor('tugas/edit_semhas/diterima/'.$d->id.'/'.$d->nim,'<button type="button" class="btn btn-success" OnClick="return confirm(\'Yakin Data ini Diterima ?\')">Diterima</button>')."
																	". anchor('tugas/edit_semhas/ditolak/'.$d->id.'/'.$d->nim,'<button type="button" class="btn btn-warning" OnClick="return confirm(\'Yakin Data ini Ditolak ?\')">Ditolak</button>')."</td>
																</tr>

			...
			<div id="content">
				<section>
					...
					<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Data Skripsi</h2>
							</div><!--end .col -->
							<!--<div class="col-lg-7">
							...
							<div class="col-lg-12">
								<form class="form-horizontal" method="post" action="<?php echo base_url().'tugas/insert_skripsi';?>">
									<div class="card">
										...
										<div class="card-body">
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<label for="Nomor Skripsi" class="col-sm-4 control-label">Nomor Skripsi</label>
														<div class="col-sm-8">
															<input type="text" class="form-control" id="id_skripsi" name="id_skripsi"/>
														</div>
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label for="Judul Skripsi" class="col-sm-4 control-label">Judul Skripsi</label>
														<div class="col-sm-8">
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="nim" name="sk_pembimbing"/>
												</div>
											</div>
											<div class="form-group">
												<label for="SK Pembimbing" class="col-sm-2 control-label">Nomor SK Pembanding</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="nim" name="sk_pembanding"/>
												</div>
											</div>
											<div class="form-group">

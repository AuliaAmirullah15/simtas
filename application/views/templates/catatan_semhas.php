				...
				<div class="section-body">
					...
					"<div class=\"alert alert-success\" role=\"alert\">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<h2 class="text-primary">Form Penilaian Seminar Hasil</h2>
							</div><!--end .col -->
							<!--<div class="col-lg-7">
							...
							<div class="col-lg-12">
									...
									<div class="card">
										<div class="card-head style-primary">
											<header>Tambah Catatan Perbaikan</header>
										</div>
                                        
                                        
										<div class="card-body">
                                          <h4>Catatan Perbaikan Seminar Hasil</h4>
                                            <?php if($catatan != null) {?>
                                                <div class="col-sm-12">
...
<th class="sort-alpha">Action</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo base_url('Tugas/hapus_catatan_semhas/'. $c->id.'/'. $c->nim.'/'. $c->id_jadwal_seminar.'/'.$id_pengajuan);?>"><button class="btn btn-warning" onclick="return confirm('Anda yakin menghapus catatan ini? Anda tidak akan melihat catatan ini di kemudian hari!')">Hapus</button></a></td>
                                                        </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
                                            ...
                                            <?php }  ?>
                                            <a href="<?php echo base_url('Tugas/list_mahasiswa_seminar/'. $id_jadwal); ?>"><button type="button" class="btn btn-info" value="back">Kembali</button></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal form-validate floating-label" method="post" action="<?php echo base_url().'tugas/tambah_catatan_perbaikan_semhas/'. $nim.'/'. $id_pengajuan.'/'.$id_jadwal.'/'. $kd_dsn.'/'. $status_dopim;?>" novalidate="novalidate">

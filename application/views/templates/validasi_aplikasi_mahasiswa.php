										...
										<tbody>
                                            <?php $no=1; foreach($data as $d) { ?>
                                                <tr>
                                                    <td><?= $no++ ?></td>
                                                    <td><?= $d->nim ?></td>
                                                    <td><a href="<?php echo base_url('berkas_mahasiswa/'.$d->cd); ?>"><?= $d->cd ?></a></td>
                                                    <td><a href="<?php echo base_url('berkas_mahasiswa/'.$d->kode); ?>"><?= $d->kode ?></a></td>
                                                    <td><a href="<?php echo base_url('berkas_mahasiswa/'.$d->jurnal); ?>"><?= $d->jurnal ?></a></td>
                                                    <td><a href="<?php echo base_url('berkas_mahasiswa/'.$d->program); ?>"><?= $d->program ?></a></td>
                                                </tr>
                                            <?php } ?>

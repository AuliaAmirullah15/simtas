				...
				<div class="section-body">
					...
					"<div class=\"alert alert-success\" role=\"alert\">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<ol class="breadcrumb">
											<li><a href="<?php echo base_url('tugas/akun');?>">List Akun User</a></li>
							...
							<div class="col-lg-12">
								<form class="form-horizontal form-validate floating-label" method="post" action="<?php echo base_url().'tugas/edit_akun_users';?>" novalidate="novalidate">
									<div class="card">
										...
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" id="Name1" name="username" data-rule-minlength="5" value="<?php echo $username ;?>"
													/>
												</div>
											</div>
											</div>

				...
				<section>
					...
					<div class="section-body contain-lg">
						...
						<?php
							...
							{
								$id=$tes->id_tesis;
								$judul=$tes->judul_skripsi;
								$nim=$tes->nim;
								$nama=$tes->nama_mhs;
								$prodi=$tes->kode_PS;
								$pembimbing1=$tes->kode_pembimbing1;
								$pembimbing2=$tes->kode_pembimbing2;
								$tgl=$tes->Tgl_lulus;
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-8">
								<form class="form" method="post" action="<?php echo base_url().'tugas/update_tes';?>" /> 
									<div class="card">
										<div class="card-head style-primary">
											<header>Edit Data Tesis</header>
										</div>
										<div class="card-body">
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														<input type="text" class="form-control" id="Firstname1" name="id_tesis" value="<?php
														echo $id;?>" disabled>
														<input type="hidden" name="id_tesis" value="<?php echo $id;?>" >
														<label for="Nomor Disertasi">Nomor Tesis</label>
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<input type="text" class="form-control" id="Lastname1" name="judul_skripsi" value="<?php
														echo $judul;?>">
														<label for="Lastname1">Judul</label>
													</div>
												</div>
											</div>

											<div class="form-group">
												<input type="text" class="form-control" id="Username1" name="nim" value="<?php
														echo $nim;?>">
												<label for="Username1">NIM</label>
											</div>
											<div class="form-group">
												<input type="text" class="form-control" id="Username1" name="nama_mhs" value="<?php
														echo $nama;?>">
												<label for="Username1">Nama Mahasiswa</label>
											</div>
											<div class="form-group">

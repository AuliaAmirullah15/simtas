									...
									<table id="datatable1" class="table table-striped table-hover">
										<thead>
											<tr>
                                                ...
                                                <th class="sort-numeric">Status Pengambilan</th>
                                                <th>Action</th>
											</tr>
										</thead>
										<tbody>
										<!-- content of table -->
												...
												<tr>
                                                    ...
                                                    <td><b><?php if($d->status == 'lulus') { echo "<p style='color:green;'>Sudah Diperbolehkan"; } else {echo "Belum Diperbolehkan";}?></b></td>
                                                    <td><a href="<?php echo base_url('Tugas/lihat_detail_ijazah/'. $d->nim);?>"><button class="btn btn-info">Lihat Detail</button></a></td>
												</tr>
												<?php } ?>

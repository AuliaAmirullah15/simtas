				...
				<section>
					...
					<div class=\"section-body\">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<form class="form-horizontal" method="post" action="<?php echo base_url().'tugas/insert_prodi';?>">
									<div class="card">
										<div class="card-head style-primary">
											<header>Tambah Program Studi</header>
										</div>
										<div class="card-body">
											
											<div class="form-group">
												<label for="Kode Program Studi" class="col-sm-2 control-label">Kode Program Studi</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="id_PS" name="id_PS"
													/>
												</div>
											</div>
											<div class="form-group">
												<label for="Nama Program Studi" class="col-sm-2 control-label">Nama Program Studi</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="nama_PS" name="nama_PS"/>
												</div>
											</div>
                                            <div class="form-group">
												<label for="Syarat SKS" class="col-sm-2 control-label">Syarat SKS</label>
												<div class="col-sm-1">
													<input type="number" class="form-control" id="syarat_sks" name="syarat_sks"/>
												</div>
											</div>

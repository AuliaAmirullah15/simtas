			...
			<div class="section-header">
							<div class="section-header">
										<ol class="breadcrumb">
											...
											<li><a href="<?php echo base_url('tugas/edit_jadwal/'.$id);?>">Edit Jadwal</a></li>
											<li class="active">Pilih Mahasiswa</li>
										</ol>
					</div>
					</div>
								...
								<div class="table-responsive">
									...
									<table class="table no-margin">
										...
										<tbody>
											...
											<tr>
												<td><input value="<?= $plh->nim ?>" name="mahasiswa[]" type="checkbox"></td>
												<td><?php echo $plh->nim;?></td>
												<td><?php echo $plh->nama;?></td>
											</tr>
											<?php } ?>
										</tbody>
									</table>
									<button name="submit" class="btn btn-default" type="submit">Pilih</button>
									</form>

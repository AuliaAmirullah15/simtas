            	 ...
            	 ?>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="pull-right">
                                            <button class="btn btn-info" name="cetak" value="cetak">CETAK</button>
                                        </div>
                                    </div>
                                </div>
										</form>
									...
									<table id="" class="table table-striped table-hover">
										...
										<!-- content of table -->
												...
												<tr>
													...
													<td><?php echo anchor('tugas/update_skripsi/'.$d->nim,'<button type="button" class="btn btn-info">Edit</button>'); ?></td>
													<td><?php echo anchor('tugas/delete_skripsi/'.$d->nim,'<button type="button" class="btn btn-warning" OnClick="return confirm(\'Yakin Ingin Menghapus Data ini ?\')">Hapus</button>',array('class'=>'delete_skripsi',
						'onclick'=>"return confirmDialog('Yakin Ingin Menghapus?');")

													); ?></td><?php } ?>
													<td><?php echo anchor('tugas/detail_skripsi/'.$d->nim,'<button type="button" class="btn btn-success">Detail</button>'); ?></td>
												</tr>
												<?php } ?>
								...
								<div class="row">
									<div class="col-sm-5"><?php if($_SESSION['level'] == '1') { ?><?php echo anchor('tugas/tambah_skripsi/','<button type="button" class="btn btn-success">Tambah Data</button>',array('class'=>'tambah_skripsi')); ?><?php } ?></div>

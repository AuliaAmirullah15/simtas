			...
			<div id="content">
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
                            <li><a href="<?php echo base_url().'Admin/manajemen_akun';?>">Manajemen Akun</a></li>
							<li class="active"><?= $judul ?></li>
						</ol>
					</div>
					<div class="section-body contain-lg">
                        <?php if($message != "" OR $message != null) {  if($message == "Berhasil Menambah Folder Baru"  OR $message == "Berhasil Menghapus Folder" OR $message == "Berhasil Mengupdate Akun") { ?>
										...
										<div class="col-md-12">
											<article class="style-default-bright">
												...
												<!-- Start Form Pengajuan Judul -->
													<form class="form" method="post" <?php if($set == 'tambah_akun') { ?> action="<?php echo base_url().'admin/proses_tambah_akun';?>" <?php } else { ?> action="<?php echo base_url().'admin/proses_edit_akun/'.$id;?>" <?php } ?>  >
									<div class="card">
                                        ...
                                        <div class="form-group">
												<input type="text" class="form-control" id="Username2" name="username" <?php if($set == 'edit_akun') {echo "value='".$username."'"; } ?> <?php if($set == 'tambah_akun') {echo "required";} ?> >
												<label for="Username2">Username</label>
											</div>
											<div class="form-group">
                                                <input type="text" class="form-control" id="Username2" name="password" <?php if($set == 'tambah_akun') {echo "required";} ?> >
												<label for="Username2"><?php if($set == 'tambah_akun') {echo "Password";} else{echo "Password Baru";} ?></label>
											</div>
											
										</div><!--end .card-body -->
										<div class="card-actionbar">
											<div class="card-actionbar-row">
												<button type="submit" class="btn btn-flat btn-primary ink-reaction" name="tombol" value="tambah">Tambah Akun</button>
											</div>
										</div>
									</div><!--end .card -->

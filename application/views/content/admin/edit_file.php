				...
				<section>
					<div class="section-header">
						<ol class="breadcrumb">
                            ...
                            <li><a href="<?php echo base_url().'Admin/detail_folder/'.$id_folder;?>"><?= $nama_folder ?></a></li>
							<li class="active">Edit File</li>
						</ol>
					</div>
					<div class="section-body contain-lg">
                        <?php if($message != "" OR $message != null) {  if($message == "Berhasil Menambah Folder Baru"  OR $message == "Berhasil Mengupdate File") { ?>
										...
										<div class="col-md-12">
											<article class="style-default-bright">
												...
												<!-- Start Form Pengajuan Judul -->
													<form class="form" method="post" action="<?php echo base_url().'admin/update_upload/'.$id;?>" enctype="multipart/form-data">
									<div class="card">
                                        ...
                                        <div class="form-group">
												<input type="text" class="form-control" id="Username2" name="judul_file" value="<?= $judul_file ?>">
										...
										<div class="card-actionbar">
											<div class="card-actionbar-row">
												<button type="submit" class="btn btn-flat btn-primary ink-reaction" name="tombol">Update</button>
											</div>
										</div>
									</div><!--end .card -->

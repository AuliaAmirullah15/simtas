	...
	<body class="menubar-hoverable header-fixed ">
		...
		<section class="section-account">
			...
			<div class="card contain-sm style-transparent">
				...
				<div class="card-body">
				<center><strong><h2 class="text-primary">Repositori USU</h2></strong></center>
					<div class="row">
								...
								<div class="row">
									<div class="col-xs-6 text-left">
										<div class="checkbox checkbox-inline checkbox-styled">
											<label>
												Kembali Ke <?php echo anchor('user/index','<strong>Halaman Utama</strong>') ; ?>
											</label>
										</div>
									</div><!--end .col -->
